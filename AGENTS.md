...
- **Domain:** `taskerha_companion`
- **Title:** TaskerHA Companion
- **Repository:** db1996/taskerha-hacs

**Key directories:**

- `custom_components/taskerha_companion/` - Main integration code
...
- Integration logs: `custom_components.taskerha_companion: debug` in `config/configuration.yaml`
...
- **Domain:** `taskerha_companion`
- **Title:** TaskerHA Companion
- **Class prefix:** `TaskerHACompanion`

**When creating new files:**

- Use the domain `taskerha_companion` for all DOMAIN references
- Prefix all integration-specific classes with `TaskerHACompanion`
- Use "TaskerHA Companion" as the display title
...
- Inherit from platform base + `TaskerHACompanionEntity`
...
- `tests/` mirrors `custom_components/taskerha_companion/` structure
