...
- **Main code:** `custom_components/taskerha_companion/`
...
- `entity/` — Base entity class (`TaskerHACompanionEntity`)
...
- Entity MRO: `(PlatformEntity, TaskerHACompanionEntity)` — order matters
...
- Debug level: `custom_components.taskerha_companion: debug` in `config/configuration.yaml`
