...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/db1996/taskerha-hacs?quickstart=1)
...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=jpawlowski&repository=taskerha-hacs&category=integration)
...
1. Download the `custom_components/taskerha_companion/` folder from this repository
...
[![Open your Home Assistant instance and start setting up a new integration.](https://my.home-assistant.io/badges/config_flow_start.svg)](https://my.home-assistant.io/redirect/config_flow_start/?domain=taskerha_companion)
...
3. Search for "TaskerHA Companion"
...
Find all entities in **Settings** → **Devices & Services** → **TaskerHA Companion** → click on the device.
...
### `taskerha_companion.example_action`
...
```yaml
service: taskerha_companion.example_action
data:
  # Add your parameters here
```

### `taskerha_companion.reload_data`
...
```yaml
service: taskerha_companion.reload_data
```
...
logger:
  default: info
  logs:
    custom_components.taskerha_companion: debug
```
...
4. Check the integration diagnostics (Settings → Devices & Services → TaskerHA Companion → 3 dots → Download diagnostics)
...
**Made with ❤️ by [@db1996][user_profile]**

---

[commits-shield]: https://img.shields.io/github/commit-activity/y/db1996/taskerha-hacs.svg?style=for-the-badge
[commits]: https://github.com/db1996/taskerha-hacs/commits/main
[hacs]: https://github.com/hacs/integration
[hacsbadge]: https://img.shields.io/badge/HACS-Default-orange.svg?style=for-the-badge
[license-shield]: https://img.shields.io/github/license/db1996/taskerha-hacs.svg?style=for-the-badge
[maintenance-shield]: https://img.shields.io/badge/maintainer-%40db1996-blue.svg?style=for-the-badge
[releases-shield]: https://img.shields.io/github/release/db1996/taskerha-hacs.svg?style=for-the-badge
[releases]: https://github.com/db1996/taskerha-hacs/releases
