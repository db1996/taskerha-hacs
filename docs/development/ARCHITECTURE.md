...
This document describes the technical architecture of the TaskerHA Companion custom component for Home Assistant.

## Directory Structure

```text
custom_components/taskerha_companion/
...
│   ├── __init__.py          # Exports TaskerHACompanionDataUpdateCoordinator
...
│   ├── __init__.py          # Exports TaskerHACompanionEntity
...
- `base.py` - Main coordinator class (`TaskerHACompanionDataUpdateCoordinator`)
...
**Key class:** `TaskerHACompanionDataUpdateCoordinator` (exported from `coordinator/__init__.py`)
...
**Key class:** `TaskerHACompanionApiClient`
...
- `TaskerHACompanionConfigFlowHandler` (main flow)
- `TaskerHACompanionOptionsFlow` (options)
...
**Key class:** `TaskerHACompanionEntity` (in `entity/base.py`)
...
2. `TaskerHACompanionEntity` for common functionality
...
1. Create directory: `custom_components/taskerha_companion/<platform>/`
2. Implement `__init__.py` with `async_setup_entry()`
3. Create entity classes inheriting from platform base + `TaskerHACompanionEntity`
