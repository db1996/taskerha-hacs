# Getting Started with TaskerHA Companion

This guide will help you install and set up the TaskerHA Companion custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/db1996/taskerha-hacs`
6. Set category to "Integration"
7. Click "Add"
8. Find "TaskerHA Companion" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/db1996/taskerha-hacs/releases)
2. Extract the `taskerha_companion` folder from the archive
3. Copy it to `custom_components/taskerha_companion/` in your Home Assistant configuration directory
...
4. Select entities from "TaskerHA Companion"

Example entities card:

```yaml
type: entities
title: TaskerHA Companion
entities:
...
- Report issues at [GitHub Issues](https://github.com/db1996/taskerha-hacs/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/db1996/taskerha-hacs/discussions)
